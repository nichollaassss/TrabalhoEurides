...
CARDAPIO vet[10] = { {1, "Bolo de Chocolate", 7.90}, {2, "Bolo de Prestígio", 7.90}, {3, "Bolo de Limão", 5.90}, {4, "Bolo de Cenoura Com Chocolate", 8.90}, {5, "Bolo de Leite de Ninho", 6.90}, {6, "Bolo de Churros", 8.90}, {7, "Bolo de Beijinho", 7.90}, {8, "Chocolate-Quente", 4.90}, {9, "Suco Natural", 9.90}, {10, "Rocambole", 11.90}};
CARDAPIO r;
...
{	switch (opc)
	{
		case '0': exit(0);                                break;
		case '1':{CadastraProduto(); SalvarProduto();}     break;
